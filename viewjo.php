...
<div class="row ml-1">
  ...
  <div class="ml-auto mr-3">
    ...
    echo'
      ...
      <p class="card-text mt-4"><small class="text-muted">'.$row['uploaded_date'].'</small></p>
    </div>
...
<div class="card mb-4">
  ...
  <div class="card-body">
    ...
    echo'
    <a class="btn btn-secondary" href="editcomjo.php?idimg='.$idimg.'&idnewc='.$idnewc.'&idcom='.$idcom.'">Edit</a>
    <a class="btn btn-danger" href="delcomjo.php?idimg='.$idimg.'&idnewc='.$idnewc.'&idcom='.$idcom.'">Delete</a>
    ';
    }
    echo'
...
if(isset($_POST['com'])){
    ...
    $stmt->execute();
    echo("<script>location.href = 'viewjo.php?idimg=$idimg&idnewc=$idnewc';</script>");
}
